...
tamanhos_bytes = [1500, 3000, 4500, 6000, 7500, 9000, 10500, 12000, 13500, 15000]
...
for tamanho in tamanhos_bytes:
    ...
    crc_manual_result = crc_manual.calcular_crc_manual(mensagem_bits, "11000000000000101") # G(x) do CRC-16/MODBUS
